...
struct ObstacleArrayMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::costmap_converter::ObstacleMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::costmap_converter::ObstacleMsg_<ContainerAllocator> >> _obstacles_type;
...
bool operator==(const ::costmap_converter::ObstacleArrayMsg_<ContainerAllocator1> & lhs, const ::costmap_converter::ObstacleArrayMsg_<ContainerAllocator2> & rhs)
{
