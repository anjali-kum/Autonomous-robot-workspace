...
echo_and_run cd "/home/ubuntu/ak_ws/src/audio_common/sound_play"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/ubuntu/ak_ws/build/audio_common/sound_play \
    build --build-base "/home/ubuntu/ak_ws/build/audio_common/sound_play" \
    install \
    --root="${DESTDIR-/}" \
