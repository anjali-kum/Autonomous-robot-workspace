...
class map_navigation():
  ...
  def __init__(self):
    ...
    self.z = 0.543
    self.w = 0.840
    self.xOffice1 = 13.340
    self.yOffice1 = -0.247
    self.x1 = 0.0
    self.y1 = 0.0
    self.z1 = 1.000
    self.w1 = -0.017
    self.xOffice2= 13.380
    self.yOffice2 = 1.716
    self.x2 = 0.0
    self.y2 = 0.0
    self.z2 = 1.000
    self.w2 = 0.011
    self.xOffice3 = 13.519
    self.yOffice3 = 2.503
    self.x3 = 0.0
    self.y3 = 0.0
    self.z3 = 1.000
    self.w3 = 0.014
    self.xOffice4 = 13.533
    self.yOffice4 = 4.800
    self.x4 = 0.0
    self.y4 = 0.0
    self.z4 = 1.000
    self.w4 = -0.025
    self.xOffice5 = 13.360 #11.262
    self.yOffice5 = 6.730 #-0.240
    self.x5 = 0.0
    self.y5 = 0.0
    self.z5 = 1.000 #0.658
    self.w5 = 0.014
    self.xOffice6= 13.759
    self.yOffice6 = 4.529
    self.x6 = 0.0
    self.y6 = 0.0
    self.z6 = -0.007
    self.w6 = 1.000
    self.xOffice7 = 13.849
    self.yOffice7 = 7.101
    self.x7 = 0.0
    self.y7 = 0.0
    self.z7 = 0.005
    self.w7 = 1.000
    self.xOffice8 = 13.724
    self.yOffice8 = 9.710
    self.x8 = 0.0
    self.y8 = 0.0
    self.z8 = -0.004
    self.w8 = 1.000
    self.xOffice9 = 13.853
    self.yOffice9 = 0.007
    self.x9 = 0.0
    self.y9 = 0.0
    self.z9 = -0.030
    self.w9 = 1.000
    self.xOffice10 = 13.734
    self.yOffice10 = -2.507
    self.x10 = 0.0
    self.y10 = 0.0
    self.z10 = -0.018
    self.w10 = 1.000
    self.xOffice11 = 13.613
    self.yOffice11 = -4.500
    self.x11 = 0.0
    self.y11 = 0.0
    self.z11 = 0.015
    self.w11 = 1.000
    ...
    if (choice == 0):
      ...
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice13, self.yOffice13, self.x13, self.y13, self.z13, self.w13)
    elif (choice == 14):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice14, self.yOffice14, self.x14, self.y14, self.z14, self.w14)
    elif (choice == 15):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice15, self.yOffice15, self.x15, self.y15, self.z15, self.w15)
    elif (choice == 16):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice16, self.yOffice16, self.x16, self.y16, self.z16, self.w16)
    elif (choice == 17):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice17, self.yOffice17, self.x17, self.y17, self.z17, self.w17)
    elif (choice == 18):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice18, self.yOffice18, self.x18, self.y18, self.z18, self.w18)
    elif (choice == 19):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice19, self.yOffice19, self.x19, self.y19, self.z19, self.w19)
    elif (choice == 20):
      playsound(path_to_sounds+"shubhadinam.wav")
      self.goalReached = self.moveToGoal(self.xOffice20, self.yOffice20, self.x20, self.y20, self.z20, self.w20)
