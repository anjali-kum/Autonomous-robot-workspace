...
//*************** Motor Pin Numbers Declaration ************************************************************************************************************************//
#define dir_rig 8
#define pwm_rig 6
#define dir_lef 9
#define pwm_lef 7

// Interrupt pin macros for right motor encoders
#define INTERRUPT_PIN_RAIS_A_RIG 31
//#define INTERRUPT_PIN_FAL_A_RIG 33 // comment these line bcoz using two pins for right encoder
#define INTERRUPT_PIN_RAIS_B_RIG 35
//#define INTERRUPT_PIN_FAL_B_RIG 37  comment these line bcoz using two pins for right encoder

// Interrupt pin macros for left motor encoders
#define INTERRUPT_PIN_RAIS_A_LEF 22
//#define INTERRUPT_PIN_FAL_A_LEF 23 //comment these line bcoz using two pins for right encoder
#define INTERRUPT_PIN_RAIS_B_LEF 24
//#define INTERRUPT_PIN_FAL_B_LEF 25  //comment these line bcoz using two pins for right encoder

//*************** Loop Time Declaration ********************************************
...
//*************** Ultrasonic Input Pin Numbers Declaration **************************
...
//*************** Encoder Input Pin Numbers Declaration *****************************
...
void setup()
{
  ...
  **************************************************************/
  ...
  /**************************************************************
    Encoders and Motors Initialization
  **************************************************************/
...
//  pinMode(echoPin, INPUT);
  ...
  //  pinMode(INTERRUPT_PIN_FAL_A_RIG, INPUT_PULLUP);
  //  attachInterrupt(digitalPinToInterrupt(INTERRUPT_PIN_FAL_A_RIG), fall_a_rig, FALLING);
  ...
  //  pinMode(INTERRUPT_PIN_FAL_B_RIG, INPUT_PULLUP);
  //  attachInterrupt(digitalPinToInterrupt(INTERRUPT_PIN_FAL_B_RIG), fall_b_rig, FALLING);
  ...
  //  pinMode(INTERRUPT_PIN_FAL_A_LEF, INPUT_PULLUP);
  //  attachInterrupt(digitalPinToInterrupt(INTERRUPT_PIN_FAL_A_LEF), fall_a_lef, FALLING);
  ...
  //  pinMode(INTERRUPT_PIN_FAL_B_LEF, INPUT_PULLUP);
  //  attachInterrupt(digitalPinToInterrupt(INTERRUPT_PIN_FAL_B_LEF), fall_b_lef, FALLING);
}
